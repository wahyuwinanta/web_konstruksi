...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\KULIAH\SKRIPSI-APP\konstruksi_web\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\KULIAH\\SKRIPSI-APP\\konstruksi_web\\public\\storage',
...
'web','api',);
        registerArgumentsSet('routes', 'front.index','front.team','front.about','front.appointment',
'front.appointment_store','dashboard','admin.users.index','admin.users.create','admin.users.store',
'admin.users.edit','admin.users.update','admin.users.destroy','admin.users.toggle','admin.projects.index',
'admin.projects.create','admin.projects.store','admin.projects.show','admin.projects.edit','admin.projects.update',
'admin.projects.destroy','admin.projects.assign','admin.projects.removeEmployee','admin.statistics.index','admin.statistics.create',
'admin.statistics.store','admin.statistics.show','admin.statistics.edit','admin.statistics.update','admin.statistics.destroy',
'admin.products.index','admin.products.create','admin.products.store','admin.products.show','admin.products.edit',
'admin.products.update','admin.products.destroy','admin.principles.index','admin.principles.create','admin.principles.store',
'admin.principles.show','admin.principles.edit','admin.principles.update','admin.principles.destroy','admin.testimonials.index',
'admin.testimonials.create','admin.testimonials.store','admin.testimonials.show','admin.testimonials.edit','admin.testimonials.update',
'admin.testimonials.destroy','admin.clients.index','admin.clients.create','admin.clients.store','admin.clients.show',
'admin.clients.edit','admin.clients.update','admin.clients.destroy','admin.teams.index','admin.teams.create',
'admin.teams.store','admin.teams.show','admin.teams.edit','admin.teams.update','admin.teams.destroy',
'admin.abouts.index','admin.abouts.create','admin.abouts.store','admin.abouts.show','admin.abouts.edit',
'admin.abouts.update','admin.abouts.destroy','admin.appointments.index','admin.appointments.create','admin.appointments.store',
'admin.appointments.show','admin.appointments.edit','admin.appointments.update','admin.appointments.destroy','admin.hero_sections.index',
'admin.hero_sections.create','admin.hero_sections.store','admin.hero_sections.show','admin.hero_sections.edit','admin.hero_sections.update',
'admin.hero_sections.destroy','profile.editAdmin','pimpinan.projects.index','pimpinan.projects.show','pimpinan.projects.finish',
'profile.editPimpinan','pimpinan.dashboard','pegawai.dashboard','pegawai.dashboard','pegawai.tasks',
'pegawai.projects','pegawai.projects.show','pegawai.projects.progress.store','profile.editPegawai','profile.update',
'profile.destroy','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.abouts.create','admin.abouts.edit','admin.abouts.index','admin.appointments.details','admin.appointments.index',
'admin.clients.create','admin.clients.edit','admin.clients.index','admin.hero_sections.create','admin.hero_sections.edit',
'admin.hero_sections.index','admin.principles.create','admin.principles.edit','admin.principles.index','admin.products.create',
'admin.products.edit','admin.products.index','admin.projects.create','admin.projects.edit','admin.projects.index',
'admin.statistics.create','admin.statistics.edit','admin.statistics.index','admin.teams.create','admin.teams.edit',
'admin.teams.index','admin.testimonials.create','admin.testimonials.edit','admin.testimonials.index','admin.users.create',
'admin.users.edit','admin.users.index','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.verify-email','components.application-logo','components.auth-session-status',
'components.danger-button','components.dropdown','components.dropdown-link','components.footer','components.input-error',
'components.input-label','components.modal','components.nav-link','components.navbar','components.primary-button',
'components.responsive-nav-link','components.secondary-button','components.text-input','components.whatsapp-bubble','dashboard',
'front.about','front.appointment','front.index','front.layouts.app','front.team',
'layouts.app','layouts.guest','layouts.navigation','layouts.pegawai','pimpinan.dashboard',
'pegawai.dashboard','pegawai.projects.index','pegawai.projects.show','pegawai.tasks','profile.editAdmin',
'profile.editPimpinan','profile.editPegawai','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
...
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.KULIAH.SKRIPSI-APP.konstruksi_web.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
