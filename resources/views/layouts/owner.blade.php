...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <nav class="bottom-nav sm:hidden">
        <a href="{{ route('owner.dashboard') }}"
            class="bottom-nav-item {{ request()->routeIs('owner.dashboard') ? 'active' : '' }}">
        ...
        <a href="{{ route('owner.projects') }}"
            class="bottom-nav-item {{ request()->routeIs('owner.projects*') ? 'active' : '' }}">
            <div class="nav-icon-wrapper">
        ...
        <a href="{{ route('owner.notifications') }}"
            class="bottom-nav-item {{ request()->routeIs('owner.notifications*') ? 'active' : '' }}">
            <div class="nav-icon-wrapper">
        ...
        <a href="{{ route('profile.editOwner') }}"
            class="bottom-nav-item {{ request()->routeIs('owner.profile') ? 'active' : '' }}">
            <div class="nav-icon-wrapper">
