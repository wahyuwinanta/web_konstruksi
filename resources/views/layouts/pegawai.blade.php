...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <nav class="bottom-nav sm:hidden">
        <a href="{{ route('pegawai.dashboard') }}"
            class="bottom-nav-item {{ request()->routeIs('pegawai.dashboard') ? 'active' : '' }}">
        ...
        <a href="{{ route('pegawai.projects') }}"
            class="bottom-nav-item {{ request()->routeIs('pegawai.projects*') ? 'active' : '' }}">
            <div class="nav-icon-wrapper">
        ...
        <a href="{{ route('pegawai.notifications') }}"
            class="bottom-nav-item {{ request()->routeIs('pegawai.notifications*') ? 'active' : '' }}">
            <div class="nav-icon-wrapper">
        ...
        <a href="{{ route('profile.editPegawai') }}"
            class="bottom-nav-item {{ request()->routeIs('pegawai.profile') ? 'active' : '' }}">
            <div class="nav-icon-wrapper">
