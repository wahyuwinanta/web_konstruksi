            ...
            <div
                ...
                @forelse ($principles as $principle)
                    <div
                        ...
                        {{-- Bagian Thumbnail dan Informasi --}}
                            ...
                            <div>
                                ...
                                @if ($principle->subtitle)
                                    <p class="text-slate-500 text-sm mt-1">
                                        {{ Str::limit($principle->subtitle, 60) }}
                                    </p>
                                @endif
                            </div>
                        </div>

                        {{-- Bagian Tanggal Pembuatan --}}
                        ...
                        <div class="mt-5 md:mt-0 flex flex-row gap-x-3">
                            ...
                            <form action="{{ route('admin.principles.destroy', $principle) }}" method="POST"
                                onsubmit="return confirm('Are you sure you want to delete this principle?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
